...
<div class="container-fluid">
    <div class="settings-container">
        ...
        <div class="settings-section" id="branding-section">
            <div class="settings-header" onclick="toggleSection('branding')">
                <div>
                    <h3>Branding</h3>
                    <p>Upload logos, set publication icon and define brand colour</p>
                </div>
                <div class="settings-actions">
                    <button type="button" class="edit-toggle" onclick="toggleEdit(event, 'branding')">
                        <i class="ti ti-edit mr-1"></i>Edit
                    </button>
                </div>
            </div>
                ...
                <form id="branding-form">
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <div class="upload-area" id="logo-upload" onclick="uploadImage('logo')">
                                <cfif len(settings.logo)>
                                    <div class="has-image">
                                        <img src="<cfoutput>#settings.logo#</cfoutput>" alt="Logo">
                                        <div class="remove-image" onclick="removeImage(event, 'logo')">Remove</div>
                                    </div>
                                <cfelse>
                            ...
                            <input type="hidden" id="logo-input" name="logo" value="<cfoutput>#settings.logo#</cfoutput>">
                        </div>
                        <div class="form-group">
                            <label>Publication icon</label>
                            <div class="upload-area" id="icon-upload" onclick="uploadImage('icon')">
                                <cfif len(settings.icon)>
                                    <div class="has-image">
                                        <img src="<cfoutput>#settings.icon#</cfoutput>" alt="Icon">
                                        <div class="remove-image" onclick="removeImage(event, 'icon')">Remove</div>
                                    </div>
                                <cfelse>
                                    <i class="ti ti-upload text-3xl text-gray-400"></i>
                                    <p class="mt-2 text-sm text-gray-600">Click to upload icon</p>
                                </cfif>
                            </div>
                            <input type="hidden" id="icon-input" name="icon" value="<cfoutput>#settings.icon#</cfoutput>">
                            <div class="hint">A square, social icon used in the UI of your publication, at least 60x60px</div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Publication cover</label>
                        <div class="upload-area" id="cover-upload" onclick="uploadImage('cover_image')">
                            <cfif len(settings.cover_image)>
                                <div class="has-image">
                                    <img src="<cfoutput>#settings.cover_image#</cfoutput>" alt="Cover">
                                    <div class="remove-image" onclick="removeImage(event, 'cover_image')">Remove</div>
                                </div>
                            <cfelse>
                                <i class="ti ti-upload text-3xl text-gray-400"></i>
                        ...
                        <input type="hidden" id="cover_image-input" name="cover_image" value="<cfoutput>#settings.cover_image#</cfoutput>">
                        <div class="hint">An optional large background image for your site</div>
                    </div>
                    <div class="form-group">
                        <label for="accent-color">Accent color</label>
                        <div class="color-input-wrapper">
                            <input type="color" id="accent-color" name="accent_color" value="<cfoutput>#settings.accent_color#</cfoutput>" disabled>
                            <input type="text" id="accent-color-text" value="<cfoutput>#settings.accent_color#</cfoutput>" maxlength="7" disabled>
                        </div>
                        <div class="hint">Primary colour used in your publication theme</div>
                    </div>
                    <div class="mt-4" style="display: none;" id="branding-actions">
                        <button type="button" class="btn-save" onclick="saveSettings('branding')">Save</button>
                        <button type="button" class="edit-toggle ml-2" onclick="cancelEdit('branding')">Cancel</button>
                    </div>
                </form>
            </div>
        </div>
